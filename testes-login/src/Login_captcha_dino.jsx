...
import './Login.css';
import './captcha-dino'; // <-- Certifique-se de que o arquivo do dino está no mesmo diretório

function Login_captcha_dino() { // Renomeei a função para refletir o novo jogo
...
export default Login_captcha_dino;