...
import './Login.css';
import 'captcha-simon';  

function Login_captcha_simon() { // Renomeei a função para refletir o novo jogo
        ...
        <div className="login-container">
            <form className="login-form" onSubmit={handleLogin}>
                ...
                <div style={{ margin: '15px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <captcha-simon  ref={captchaRef}></captcha-simon>
...
export default Login_captcha_simon;