...
import './Login.css';
import 'captcha-memory';  

function Login_captcha_memory() { // Renomeei a função para refletir o novo jogo
        ...
        <div className="login-container">
            <form className="login-form" onSubmit={handleLogin}>
                ...
                <div style={{ margin: '15px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <captcha-memory ref={captchaRef}></captcha-memory>
...
export default Login_captcha_memory;